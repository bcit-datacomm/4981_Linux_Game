...
bool MeleeWeapon::fire(Movable &mov){
    ...
    std::vector<Entity *> hitMarines = ch.detectMeleeCollision(ch.getQuadTreeEntities(ch.marineTree,
            &mov),&mov, hitBox);
    ...
    std::vector<Entity *> hitTurrets = ch.detectMeleeCollision(ch.getQuadTreeEntities(ch.turretTree,
            &mov),&mov, hitBox);
    ...
    std::vector<Entity *> hitBarricades = ch.detectMeleeCollision(ch.getQuadTreeEntities(ch.barricadeTree,
            &mov),&mov, hitBox);
