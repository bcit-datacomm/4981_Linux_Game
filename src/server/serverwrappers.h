...
*
* Notes:
* The header for server wrapper functions. These are small utility functions that
* simply wrap API calls, or more general functions that wrap related sections
* of code that didn't make sense in server.cpp.
* ------------------------------------------------------------------------------*/
