...
Player::Player(const int32_t& id) : tempBarricadeID(-1), tempTurretID(-1), marine(GameManager::instance()->getMarine(id)), holdingTurret(false), pickupTick(0), pickupDelay(200) {
